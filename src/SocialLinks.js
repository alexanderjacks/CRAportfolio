	...
	render() {
		return(
			<div className="d-flex justify-content-around">
				<a className="social-links" href="https://s3.amazonaws.com/bux4jax/_resume_Alexander_Jacks.pdf" target="_blank" rel="noopener noreferrer"><i class="far fa-file-pdf"></i></a>
