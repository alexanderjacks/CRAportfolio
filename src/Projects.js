...
const projects = [
	{key: 0, favicon: "images/favicon11.png", screen: "images/screens/11a.png", name:'Fight The Ban', techs:'GatsbyJS, AWS, Netlify', siteURL: 'https://www.fighttheban.org', ghURL: 'https://github.com/alexanderjacks/fighttheban', about: "Built from a <strong><em>GatsbyJS</em></strong> starter. Veterans' rights org promotional site for rallies against the ban on trans citizens servings in the US military. <strong><em>Gatsby</em></strong> is a nifty way to build static <strong><em>React</em></strong> apps that look and feel like a mobile experience. Go ahead and add this website to your Home Screen!"},
